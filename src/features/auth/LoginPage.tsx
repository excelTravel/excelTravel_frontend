              ...
              <>
                  ...
                  <div className="space-y-1">
                    <div className={cn("relative group rounded-2xl border-2 transition-all bg-secondary focus-within:bg-background", errors.name ? "border-red-300 focus-within:border-red-500" : "border-transparent focus-within:border-[#0e76db] focus-within:ring-4 focus-within:ring-[#0e76db]/10")}>
                      ...
                      <input 
                        ...
                        className="w-full bg-transparent py-4 pl-12 pr-4 text-sm font-bold placeholder:text-muted-foreground focus:outline-none"
                      />
                    </div>
                ...
                <div className="flex gap-2 items-start">
                  ...
                  <button 
                    ...
                    className="shrink-0 h-[56px] px-4 rounded-2xl bg-[#0e76db]/10 border-2 border-[#0e76db]/20 text-xs font-bold text-[#0e76db] transition-all hover:bg-[#0e76db]/20 hover:border-[#0e76db]/30 active:scale-95 disabled:opacity-50 disabled:pointer-events-none"
                  >
